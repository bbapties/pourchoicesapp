-- ============================================================================
-- ROLLBACK for sql/my-star-sort-migration.sql (2026-09-13)
-- Restores my_variant_scores (2026-09-07, #80) and the two browse views as of
-- sql/blended-star-default-2-5-migration.sql (no my_star column), drops the helper.
-- NOTE: the restored my_variant_scores is again unscoped to the caller (the latent bug).
-- ============================================================================
BEGIN;
...
DROP FUNCTION IF EXISTS public.current_public_user_id();
COMMIT;
