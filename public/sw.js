...
self.addEventListener('push', (event) => {
  ...
  const options = {
    ...
    // Android draws the status-bar badge from alpha only, so it must be a monochrome silhouette
    // (a full-colour logo there renders as a solid white square). Generated by scripts/badge_icon.mjs.
