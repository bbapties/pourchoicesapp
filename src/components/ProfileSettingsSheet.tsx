...
/**
 * Profile settings (#110). Everything the old /profile page held - username, email, notifications,
 * install, replay tutorial, feedback, sign out - now in a tray that drops from the gear on your
 * own user page. Nothing was removed; "Muted users" is new and fills in with step 6 (#111).
 */
export default function ProfileSettingsSheet({ open, onOpenChange, onUsernameChanged }: {
  open: boolean;
