...
- **Wave 1b + Wave 0 DONE** (B-09…B-24). Next is the **Auth/signup/profile** cluster (**B-25…B-28**): app password minimum, forgot-password/reset, username case-insensitive uniqueness in DB, and signup reusing `validateUsername` (B-28 largely covered by the B-08 fix — verify). `src/app/page.tsx` · `src/lib/profile.ts`.
