...
- **Wave 1b (B-09…B-17)** unless Brian reorders — start with **B-09** (Mark as Empty is SKU-wide in Social; should scope to the card's `variant_id` like My Bar already does). `SocialClient.tsx` ~170–177.
